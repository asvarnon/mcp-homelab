...
- **Docs you own:** README.md, CONTRIBUTING.md, docs/ folder, backlog/ files, deployment guides, design principles, operational runbooks
...
4. **Style consistency** — Markdown with `---` section dividers, bold labels, code blocks with language tags. Match existing formatting in each workspace.
